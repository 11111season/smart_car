...
//磁力计校准参数
float offset[3] = {
    -0.165224f, -0.074228f, 0.283815f
}; 
    
float scale[3][3] = {
    {1.031290f, 0.004914f, 0.111507f},
    {0.004914f, 1.000694f, 0.007609f},
    {0.111507f, 0.007609f, 0.981117f}
};
...
//    PT1Filter_InitWithFreq(&filter_imu_gyro_x,5,200);
