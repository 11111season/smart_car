...
/*
 * 函数名重命名：在 ST API 函数名前加 st_ 前缀，避免与用户封装的 VL53L5CX.h 接口冲突。
 * 这些宏必须放在所有函数声明之前，确保 ST API 的函数声明和定义都被正确重命名。
 */
#define vl53l5cx_init              st_vl53l5cx_init
#define vl53l5cx_start_ranging     st_vl53l5cx_start_ranging
#define vl53l5cx_stop_ranging      st_vl53l5cx_stop_ranging
#define vl53l5cx_set_resolution    st_vl53l5cx_set_resolution
